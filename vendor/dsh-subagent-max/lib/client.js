  ...
  factory: function (require) {
    ...
    if (typeof document !== "undefined") {
      ...
      if (!document.querySelector("style[data-plugin-css='" + cssId + "']")) {
        ...
        styleTag.textContent = CSS + SETTINGS_CSS;
    ...
    // ── settings row: default subagent model ──────────────────────────────
    ...
    function apply(ctx) {
      ...
      // Settings row: default subagent model (General settings page).
